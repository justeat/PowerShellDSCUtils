...
Switch ($PSVersionTable.PSVersion.Major)
{
    5 
    {
        ...
        . $PSScriptRoot\DSC\Version5DSC.ps1 -ConfigurationNames $ConfigurationNames -PullServerUrl $PullServerURL -PullServerRegKey $PullServerRegKey | Tee-Object -FilePath "$PSScriptRoot\DSC\Onboarding.log"
    } # PoSh 5
